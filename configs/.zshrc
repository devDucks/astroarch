...
function astro-rollback-indi()
{
    ...
    mkdir -p ~/.rollback
    cd ~/.rollback
    wget -O indi-3rdparty-drivers-2.0.3-1-aarch64.pkg.tar.xz http://astromatto.com:9000/aarch64/indi-3rdparty-drivers-2.0.3-1-aarch64.pkg.tar.xz
    wget -O libindi-2.0.3-1-aarch64.pkg.tar.xz http://astromatto.com:9000/aarch64/libindi-2.0.3-1-aarch64.pkg.tar.xz
    wget -O indi-3rdparty-libs-2.0.3-1-aarch64.pkg.tar.xz http://astromatto.com:9000/aarch64/indi-3rdparty-libs-2.0.3-1-aarch64.pkg.tar.xz
...
function astro-rollback-kstars()
{
    ...
    mkdir -p ~/.rollback
    cd ~/.rollback
    wget -O kstars-3.6.6-2-aarch64.pkg.tar.xz http://astromatto.com:9000/aarch64/kstars-3.6.6-2-aarch64.pkg.tar.xz
